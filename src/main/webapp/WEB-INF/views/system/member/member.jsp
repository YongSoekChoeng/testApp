...
<body>
		...
		<table class="se">
			...
			<tr>
				<td>
					...
					<input type="text" id="srch_term_start_value" name="srch_term_start_value" style="width: 120px;" placeholder="사용시작일"/> ~
					<input type="text" id="srch_term_end_value" name="srch_term_end_value" style="width: 120px;" placeholder="사용종료일"/>
	...
	<div style="display: inline-block;">
		<div class="bt_orange_S in_autr_type checkCloseMonthBtn erp_autr_type" id="bt_get_erp_data" style="background-color: #f57405; border: 1px solid #ffa150;">회사정보 ERP 동기화</div>
	</div>
...
// CI_URL
var ciPic = "<img src=\"#=kendo.toString('http://anybiz.genexon.co.kr/'+ci_url)#\" alt=\"사진\" id=\"viewArea\" style=\"width:100px; height:50px;\"/>";
// 회사 로고
var logoPic = "<img src=\"#=kendo.toString('http://anybiz.genexon.co.kr/'+logo_url)#\" alt=\"사진\" id=\"viewArea\" style=\"width:100px; height:50px;\"/>";
// 증명서 로고
var certlogoPic = "<img src=\"#=kendo.toString('http://anybiz.genexon.co.kr/'+certlogo_url)#\" alt=\"사진\" id=\"viewArea\" style=\"width:100px; height:50px;\"/>";
// 직인
var sealPic = "<img src=\"#=kendo.toString('http://anybiz.genexon.co.kr/'+seal_url)#\" alt=\"사진\" id=\"viewArea\" style=\"width:100px; height:50px;\"/>";
