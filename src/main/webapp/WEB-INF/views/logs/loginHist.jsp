...
<body>
	<input type="hidden" name="view_auth" id="view_auth" value="${menuRole.view_auth}"/>
	...
	<script type="text/javascript">
		...
		var ds = {
			transport : {
				read : {
					url : "/logs/getLoginHistList.ajax?${_csrf.parameterName}=${_csrf.token}",
					data: function() {
						return {
							json_string : genexon.getSearchParameterToJsonString()
						}
		...
		var gridpt = {
			columns : [
				...
				},
				{
					...
					width: 150,
					template: function(e) {
						var login_ip_arr = e.login_ip.split(".");
						
						return login_ip_arr[0] + "." + login_ip_arr[1] + "." + "*.*";
					}
				},
				{
					field: "memo",
