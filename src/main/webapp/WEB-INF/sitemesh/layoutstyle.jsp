...
.btn_sty01 {background:#eeeeee !important; border-radius:2px !important;border:1px solid #bbb;color:#222 !important;margin-left:-1px; line-height: 1.7; padding-top: 5px;}
.btn_sty02 {background:#000823 !important; border-radius:2px !important;}
.btn_sty03 {background:#9097a0 !important; border-radius:2px !important;border:1px solid #9097a0 !important;}
.btn_sty04 {background:#f57405 !important; border-radius:2px !important;border:1px solid #ffa150 !important;}
...
.k-primary {height:34px;font-size:13px !important}
.k-primary2 {height:34px;font-size:13px !important}
.k-input {background:transparent !important;font-size:15px !important;height:30px !important;}
.k-datepicker {}
...
button.gb01 {border:0 !important;}
button.gb01:hover{background:rgba(0,0,0,0.3)  url(/resources/images/common/ic_2.png) no-repeat 0 0;}
button.gb02 {background: rgba(255,255,255,0.2) !important;color:#000823 !important;height: 24px;padding: 0 15px !important; font-weight: bold;border:0 !important;}
button.gb02:hover {background: rgba(255,255,255,0.1) !important;color:#00e4ff !important;}

/* .k-dropdown-wrap {height:22px !important;} */
...
table.ta_sample2 th{border-bottom:1px solid #ddd !important;background:#f6f6f6;color:#000;}
table.ta_sample2 tr {border:0px !important;}
table.ta_sample2 td {padding-left:5px;}
table.ta_sample2 {border-collapse:collapse; border-spacing:0; border-top:2px solid #000;}
.essential {color:#007eff !important;}
